          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Get in touch with our team for any questions about our services or insurance plans
              </p>
            </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          <a href="tel:+12345678900" className="text-blue-600 hover:text-blue-800">
                            +1 (234) 567-8900
                          </a>
                        </p>
                      </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          <a href="mailto:contact@emart24.com" className="text-blue-600 hover:text-blue-800">
                            contact@emart24.com
                          </a>
                        </p>
                      </div>
