        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-6 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">
              ...
              <div className="text-xl text-gray-700 mb-2">${sProduct.pPrice}</div>
              <div className="text-yellow-600 font-semibold text-base mb-2">
                {sProduct.pSuperCoinReward === 0
                  ? "No Super Coins for this product"
                  : sProduct.pSuperCoinReward === 1
                  ? `Earn 1 Super Coin for this product`
                  : `Earn ${sProduct.pSuperCoinReward} Super Coins for this product`}
              </div>
                    ...
                    <Fragment>
                      ...
                      layoutData.inCart.includes(sProduct._id) === true ? (
                        ...
                        <div
                          ...
                          style={{ background: addingToCart ? "#666" : "#303031" }}
                          className={`px-4 py-2 text-white text-center ${addingToCart ? 'cursor-not-allowed' : 'cursor-pointer'} uppercase flex items-center justify-center`}
                        >
                          {addingToCart ? (
                            <>
