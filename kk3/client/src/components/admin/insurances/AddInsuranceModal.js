...
import { createInsurance, getAllInsurances } from "./FetchApi";
...
const AddInsuranceDetail = () => {
  ...
  const submitForm = async (e) => {
    ...
    let responseData = await createInsurance(formData);
    if (responseData && responseData.success) {
      ...
      setTimeout(() => {
        dispatch({ type: "addInsuranceModal", payload: false });
      }, 2000);
    ...
    <Fragment>
      <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-2xl max-h-screen overflow-y-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="text-2xl text-gray-700">Add Insurance</div>
          <div
            onClick={(e) =>
              dispatch({ type: "addInsuranceModal", payload: false })
            }
        ...
        <form className="space-y-4" onSubmit={submitForm}>
          ...
          <div>
            ...
            <input
              ...
              aria-describedby="insurance-name-help"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-1 focus:ring-gray-500"
              required
              aria-label="Insurance Description"
...
const AddInsuranceModal = (props) => {
  const { data, dispatch } = useContext(InsuranceContext);

  return (
    <Fragment>
      {data.addInsuranceModal && (
