...
const AddProductDetail = ({ categories }) => {
  ...
  const submitForm = async (e) => {
    ...
    try {
      ...
      formData.append("purchaseType", fData.purchaseType);
      formData.append("pSuperCoinReward", fData.pSuperCoinReward);
      ...
      >
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            ...
            {/* Super Coin Reward Field */}
            <div className="flex flex-col space-y-1 py-2">
              <label htmlFor="superCoinReward">Super Coin Reward</label>
              <input
                value={fData.pSuperCoinReward}
                onChange={(e) =>
                  setFdata({
                    ...fData,
                    error: false,
                    success: false,
                    pSuperCoinReward: e.target.value,
                  })
                }
                type="number"
                min="0"
                className="px-4 py-2 border focus:outline-none"
                id="superCoinReward"
                placeholder="Enter super coin reward"
              />
            </div>
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                ...
                >
                  ...
                  <option value="offline">In-Store Purchase Only</option>
                </select>
              </div>
            </div>
