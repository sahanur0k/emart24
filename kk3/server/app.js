...
const insuranceRouter = require("./src/routes/insuranceRoutes");
const insuranceClientRouter = require("./src/routes/insuranceClientRoutes");
const userAnalyticsRouter = require("./src/routes/userAnalyticsRoutes");
const blogRouter = require("./src/routes/blogRoutes");
const productQueryRouter = require("./src/routes/productQueryRoutes");
...
app.use("/api/admin/insurance-clients", insuranceClientRouter);
app.use("/api/admin/users", userAnalyticsRouter);
